...
public class ClassTiming_Activity_79 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_timing__79);
...
//                    fragmentTransaction.commit();
                    ...
                    ClassTiming_Fragment_79 classTiming_fragment = new ClassTiming_Fragment_79();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, classTiming_fragment);
                    fragmentTransaction.commit();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ClassTiming_Activity_79.this, MainActivity.class);
