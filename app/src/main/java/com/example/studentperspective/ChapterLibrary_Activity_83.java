...
public class ChapterLibrary_Activity_83 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter_library__83);
...
//                    fragmentTransaction.commit();
                    ...
                    ChapterLibrary_Fragment_83 classroomFragment = new ChapterLibrary_Fragment_83();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ChapterLibrary_Activity_83.this, MainActivity.class);
