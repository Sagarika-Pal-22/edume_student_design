...
import com.example.studentperspective.Fragment.ExamSubmit_Fragment_70;
...
public class ExamSubmit_Activity_70 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_submit__70);
...
//                    fragmentTransaction.commit();
                    ...
                    ExamSubmit_Fragment_70 examSubmit_fragment_70 = new ExamSubmit_Fragment_70();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, examSubmit_fragment_70);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ExamSubmit_Activity_70.this, MainActivity.class);
