...
public class RecyclerItemTouchHelper implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
...
public RecyclerItemTouchHelper(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
public RecyclerItemTouchHelper setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
        }

public RecyclerItemTouchHelper setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
        }

public RecyclerItemTouchHelper setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
        }
public RecyclerItemTouchHelper setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
        }

public RecyclerItemTouchHelper setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
        }

public RecyclerItemTouchHelper setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
        }

public RecyclerItemTouchHelper setIgnoredViewTypes(Integer... viewTypes) {
...
public RecyclerItemTouchHelper setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
...
public RecyclerItemTouchHelper setSwipeable(boolean value) {
...
public RecyclerItemTouchHelper setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
        }

public RecyclerItemTouchHelper setUnSwipeableRows(Integer... rows) {
...
public RecyclerItemTouchHelper setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
        }

// the entire foreground is faded out as it is opened
public RecyclerItemTouchHelper setFgFade() {
