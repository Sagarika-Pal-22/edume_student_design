...
public class ExerciseReport_Activity_54 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_report__54);
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ExerciseReport_Activity_54.this, MainActivity.class);
