...
import com.example.studentperspective.Fragment.Chat_Fragment;
...
public class ChatActivity_64_15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_64_15);
...
//                    fragmentTransaction.commit();
                    ...
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, chat_fragment);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ChatActivity_64_15.this, MainActivity.class);
