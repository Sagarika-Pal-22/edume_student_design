...
import com.example.studentperspective.Fragment.TestExam_Fragment_87_1;
...
public class TestExam_Activity_87_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_exam__87_1);
...
//                    fragmentTransaction.commit();
                    ...
                    TestExam_Fragment_87_1 classroomFragment = new TestExam_Fragment_87_1();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(TestExam_Activity_87_1.this, MainActivity.class);
