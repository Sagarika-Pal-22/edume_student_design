...
import com.example.studentperspective.Fragment.ExerciseLibrary_Fragment;
...
public class ExerciseLibrary_Activity_67 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_library__67);
...
//                    fragmentTransaction.commit();
                    ...
                    ExerciseLibrary_Fragment exerciseLibrary_fragment = new ExerciseLibrary_Fragment();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, exerciseLibrary_fragment);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ExerciseLibrary_Activity_67.this, MainActivity.class);
