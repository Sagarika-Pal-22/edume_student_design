...
import com.example.studentperspective.Fragment.Physics_Fragment_80;
...
public class Physics_Activity_80 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics__80);
...
//                    fragmentTransaction.commit();
                    ...
                    Physics_Fragment_80 physics_fragment = new Physics_Fragment_80();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, physics_fragment);
                    fragmentTransaction.commit();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(Physics_Activity_80.this, MainActivity.class);
