...
import com.example.studentperspective.Fragment.Classroom_Fragment_76_13;
...
public class Classroom_Activity_76_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classroom__76_13);
...
//                    fragmentTransaction.commit();
                    ...
                    Classroom_Fragment_76_13 classroomFragment = new Classroom_Fragment_76_13();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(Classroom_Activity_76_13.this, MainActivity.class);
