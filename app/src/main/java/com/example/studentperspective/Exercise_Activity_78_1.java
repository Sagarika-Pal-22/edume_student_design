...
import com.example.studentperspective.Fragment.Exercise_fragment_78_1;
...
public class Exercise_Activity_78_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise__78_1);
...
//                    fragmentTransaction.commit();
                    ...
                    Exercise_fragment_78_1 exercise_fragment = new Exercise_fragment_78_1();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, exercise_fragment);
                    fragmentTransaction.commit();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(Exercise_Activity_78_1.this, MainActivity.class);
