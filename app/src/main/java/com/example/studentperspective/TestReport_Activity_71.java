...
import com.example.studentperspective.Fragment.TestReport_Fragment_71;
...
public class TestReport_Activity_71 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_report__71);
...
//                    fragmentTransaction.commit();
                    ...
                    TestReport_Fragment_71 testReport_fragment_71 = new TestReport_Fragment_71();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, testReport_fragment_71);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(TestReport_Activity_71.this, MainActivity.class);
