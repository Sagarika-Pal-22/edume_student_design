...
import com.example.studentperspective.Fragment.ExerciseReport_Fragment_89_1;
...
public class ExerciseReport_Activity_89_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_report__89_1);
...
//                    fragmentTransaction.commit();
                    ...
                    ExerciseReport_Fragment_89_1 classroomFragment = new ExerciseReport_Fragment_89_1();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ExerciseReport_Activity_89_1.this, MainActivity.class);
