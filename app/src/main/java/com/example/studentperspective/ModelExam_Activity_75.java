...
import com.example.studentperspective.Fragment.ModelExam_Fragment_75;
...
public class ModelExam_Activity_75 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_exam__75);
...
//                    fragmentTransaction.commit();
                    ...
                    ModelExam_Fragment_75 modelExam_fragment_75 = new ModelExam_Fragment_75();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, modelExam_fragment_75);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ModelExam_Activity_75.this, MainActivity.class);
