...
import com.example.studentperspective.Fragment.TestReport_Fragment_89;
...
public class TestReport_Activity_89 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_report__89);
...
//                    fragmentTransaction.commit();
                    ...
                    TestReport_Fragment_89 classroomFragment = new TestReport_Fragment_89();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(TestReport_Activity_89.this, MainActivity.class);
