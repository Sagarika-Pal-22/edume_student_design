...
public class Assignment_Activity_78_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignment__78_6);
...
//                    fragmentTransaction.commit();
                    ...
                    Assignment_Fragment_78_6 assignment_fragment = new Assignment_Fragment_78_6();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, assignment_fragment);
                    fragmentTransaction.commit();
...
//                    fragmentTransaction.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(Assignment_Activity_78_6.this, MainActivity.class);
