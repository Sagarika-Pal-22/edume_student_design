...
import com.example.studentperspective.Fragment.ScreenHolding_Fragment;
import com.example.studentperspective.Fragment.ScreenSharing_Fragment;
...
public class ScreenSharing_Activity_64_14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_sharing__64_14);
...
//                    fragmentTransaction.commit();
                    ...
                    ScreenSharing_Fragment screenSharing_fragment = new ScreenSharing_Fragment();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, screenSharing_fragment);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ScreenSharing_Activity_64_14.this, MainActivity.class);
