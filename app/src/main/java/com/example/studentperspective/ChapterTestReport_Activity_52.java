...
public class ChapterTestReport_Activity_52 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter_test_report__52);
...
//                    fragmentTransaction.commit();
        ...
        bottom_navigationView.setSelectedItemId(R.id.nav_analytics);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ChapterTestReport_Activity_52.this, MainActivity.class);
