...
public class FavouriteChapter_Fragment_91 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_favourite_91,container,false);
        ...
        viewPagerAdapter.addFragment(new All_Fragment_91(), "All");
