...
public class Maths_Fragment_84 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_maths_84,container,false);
        ...
        model.add(new Model_82("3rd Term","Percentile 89%","Submitted: 19.12.20"));
        model.add(new Model_82("2nd Term","Percentile 89%","Submitted: 19.12.20"));
        model.add(new Model_82("1st Term","Percentile 89%","Submitted: 19.12.20"));
