...
public class ScreenHolding_Activity_64_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_holding__64_13);
...
//                    fragmentTransaction.commit();
                    ...
                    ScreenHolding_Fragment screenHolding_fragment = new ScreenHolding_Fragment();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.framLayout, screenHolding_fragment);
                    fragmentTransaction.commit();
                }
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(ScreenHolding_Activity_64_13.this, MainActivity.class);
